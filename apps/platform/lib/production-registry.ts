...
export const ENDPOINTS = [
  ...
  {method:"GET",path:"/api/data-entry/forms",domain:"platform",auth:"public",purpose:"Data-entry form and field registry"},
  {method:"POST",path:"/api/data-entry/process",domain:"platform",auth:"public-intake",purpose:"Validate form data and return reviewable AI assist"},
  {method:"POST",path:"/api/data-entry/xml",domain:"platform",auth:"public-intake",purpose:"Governed Comeaux XML import/export"},
  {method:"POST",path:"/api/assistant/chat",domain:"assistant",auth:"public-intake",purpose:"Governed Andreaa Chan'nel AI support"},
  {method:"POST",path:"/api/contact",domain:"consultation",auth:"public-intake",purpose:"Validate and prepare contact support packet"},
